...
/* harmony import */ var _components_tabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/_tabs */ "./src/js/components/_tabs.js");
...
/* harmony import */ var _components_map__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/_map */ "./src/js/components/_map.js");
...
/* harmony import */ var _components_tab_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/_tab-slider */ "./src/js/components/_tab-slider.js");
...
window.addEventListener('scroll', () => {
  ...
  lastScrollTop = pageYOffset <= 0 ? navbar.classList.remove('active') : pageYOffset;
}, {
  passive: true
});
...
let center = [51.58158582638408, -0.1386549761963127];
let pin = '../../img/pin.svg';
function init() {
  ...
  let placemark = new ymaps.Placemark([51.567199043912666, -0.13788250000000263], {}, {
...
/***/ "./src/js/components/_tab-slider.js":
/*!******************************************!*\
  !*** ./src/js/components/_tab-slider.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reports__swiper', {
  slidesPerView: 'auto',
  navigation: {
    prevEl: '.slide-prev',
    nextEl: '.slide-next'
...
tabBtns.forEach(el => {
  el.addEventListener('click', e => {
    ...
    document.querySelector(`.tab__content-${tab}`).classList.add('active');
  });
});
document.querySelector('.tab__content-5').addEventListener('touchstart', () => {
  document.querySelector('.tab-5__scroll-touch').style.display = 'none';
});
document.querySelector('.tab__content-5').addEventListener('touchend', () => {
  document.querySelector('.tab-5__scroll-touch').style.display = 'block';
});
document.querySelector('.tab__content-7').addEventListener('touchstart', () => {
  document.querySelector('.tab-7__scroll-touch').style.display = 'none';
});
document.querySelector('.tab__content-7').addEventListener('touchend', () => {
  document.querySelector('.tab-7__scroll-touch').style.display = 'block';
});
document.querySelector('.tab__content-8').addEventListener('touchstart', () => {
  document.querySelector('.tab-8__scroll-touch').style.display = 'none';
});
document.querySelector('.tab__content-8').addEventListener('touchend', () => {
  document.querySelector('.tab-8__scroll-touch').style.display = 'block';
});
